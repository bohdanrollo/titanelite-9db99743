      ...
      <div className="container-edge grid lg:grid-cols-12 gap-10 pt-16 pb-20 lg:pt-24 lg:pb-32">
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          <p className="mt-8 max-w-xl text-base text-muted-foreground leading-relaxed">
            Upload your blood panel for an instant lab analysis, track your calories and macros, track your stack, calculate doses, message your coach directly, ask AI peptide questions, browse the 50-compound research library,
