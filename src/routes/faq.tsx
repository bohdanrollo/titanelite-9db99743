...
const faqs = [
  ...
  { q: "What's inside the client dashboard?", a: "The dashboard is organized into four areas: Plan (your protocol, intake, and direct messaging with your coach), Research (peptide profiles, articles, lifting tips), Tools (supplies, reconstitution, injection guide, calculator, My Stack), and Assistant (Pep Talk AI chat)." },
