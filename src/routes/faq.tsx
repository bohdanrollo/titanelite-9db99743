...
const faqs = [
  ...
  { q: "What's inside the client dashboard?", a: "The dashboard is organized into four areas: Plan (your protocol, intake, and direct messaging with your coach), Research (peptide profiles, Dosing Guide, articles, lifting tips), Tools (supplies, reconstitution, injection guide, calculator, Lab Analysis, Calorie Tracker, My Stack), and Assistant (Pep Talk AI chat)." },
  { q: "Is there a dosing guide?", a: "Yes. The Dosing Guide tab covers typical research dosing ranges, escalation steps, cycling and weekly schedules for 21 compounds, plus mechanism of action and what researchers observe over time. It's included with both Limited and Full Access, and is educational research-use-only information — not medical advice." },

  { q: "Can I track my calories and macros?", a: "Yes. The Calorie Tracker tab lets you set a daily calorie goal, which automatically sets your protein, carb, and fat targets. Search foods and drinks by brand and log them with one tap and the macros fill in for you. Every day resets automatically and past days are saved in your history. It is included with both Limited and Full Access." },
  { q: "What is Lab Analysis?", a: "Lab Analysis lets you upload your blood test panel and enter your age, height, and weight. It reviews your markers and stats, flags what's outside optimal range, and explains practical ways to improve it. Your results save to your account and you can update or re-upload a new panel anytime. It's educational only and not medical advice." },
