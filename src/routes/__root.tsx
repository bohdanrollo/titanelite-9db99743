...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Titan Elite" },
      { property: "og:title", content: "Titan Elite" },
      { name: "twitter:title", content: "Titan Elite" },
      { name: "description", content: "Get a personalized weightlifting and peptide protocol to fit your specific goals!" },
      { property: "og:description", content: "Get a personalized weightlifting and peptide protocol to fit your specific goals!" },
      { name: "twitter:description", content: "Get a personalized weightlifting and peptide protocol to fit your specific goals!" },
