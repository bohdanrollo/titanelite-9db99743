...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo+Black&family=Bebas+Neue&family=DM+Sans:wght@400;500;600;700&family=Hind:wght@300;400;500;600;700&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;600;700&family=Outfit:wght@300&family=Playfair+Display:wght@400;700&family=Space+Grotesk:wght@400;500;600;700&display=swap",
      },
    ],
    scripts: [
      {
  ...
  return (
    <html lang="en">
      ...
      <body>
        {children}
        <Scripts />
        <script async type="text/javascript" src="https://static.klaviyo.com/onsite/js/WesM9W/klaviyo.js?company_id=WesM9W" />
        <script
